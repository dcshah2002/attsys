...
<section class="container py-lg-5">
  <!--User table-->
    <h1 class="slideInDown animated">Student Daily Report</h1>
    <div class="form-style-5">
      <button type="button" class="buttons_add" data-toggle="modal" data-target="#Filter-export">Report Filter/ Export to Excel</button>
    </div>
    <!-- Log filter -->
              ...
              <div class="container-fluid">
                ...
                <div class="row">
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint" class="Filter_title"><b>Filter by student:</b></label>
                  ...
                  <div class="col-lg-4 col-sm-12">
                    <label for="Fingerprint" class="Filter_title"><b>Export to Excel:</b></label>
                    <input type="submit" name="To_Excel" class="buttons_add " value="Export">
                  </div>
                </div>
              </div>
            </div>
